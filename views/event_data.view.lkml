# The name of this view in Looker is "Event Data"
view: event_data {
...
# The name of this view in Looker is "Event Data Items"
view: event_data__items {
  ...
  dimension: event_data__items {
    type: string
    hidden: yes
    sql: event_data__items ;;
  }
...
# The name of this view in Looker is "Event Data Event Params"
view: event_data__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: event_data__event_params {
    type: string
    hidden: yes
    sql: event_data__event_params ;;
  }
...
# The name of this view in Looker is "Event Data User Properties"
view: event_data__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: event_data__user_properties {
    type: string
    hidden: yes
    sql: event_data__user_properties ;;
  }
