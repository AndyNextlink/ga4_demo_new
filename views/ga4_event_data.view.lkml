# The name of this view in Looker is "Ga4 Event Data"
view: ga4_event_data {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ga4_obfuscated_sample_ecommerce.ga4_event_data`
    ;;
...
# The name of this view in Looker is "Ga4 Event Data Items"
view: ga4_event_data__items {
  ...
  dimension: ga4_event_data__items {
    type: string
    hidden: yes
    sql: ga4_event_data__items ;;
  }
...
# The name of this view in Looker is "Ga4 Event Data Event Params"
view: ga4_event_data__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ga4_event_data__event_params {
    type: string
    hidden: yes
    sql: ga4_event_data__event_params ;;
  }
...
# The name of this view in Looker is "Ga4 Event Data User Properties"
view: ga4_event_data__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: ga4_event_data__user_properties {
    type: string
    hidden: yes
    sql: ga4_event_data__user_properties ;;
  }
